...
export function usePowerLoadoutSettings(): PowerLoadoutSettings {
    ...
    return {
        ...
        deserializePowerLoadoutState(json: string) {
            ...
            setSelectedAttackTier(parsedJson.selectedAttackTier ?? PowerTier.basic)
            setSelectedDefenseTier(parsedJson.selectedDefenseTier ?? PowerTier.basic)
            setSelectedComboTier(parsedJson.selectedComboTier ?? PowerTier.basic)
            setSelectedSignatureTier(parsedJson.selectedSignatureTier ?? PowerTier.basic)
            setSelectedLocomotionTier(parsedJson.selectedLocomotionTier ?? PowerTier.basic)
