import {Accordion, AccordionDetails, AccordionSummary, Box, FormControl, InputAdornment, InputLabel, MenuItem, Select, Stack, TextField, Typography} from "@mui/material";
...
import {LevelUpSelection} from "./LevelUpSelection.tsx";
        ...
        <Stack spacing={3}>
            <Grid container spacing={1} alignItems={"stretch"}>
                <Grid style={{display: "flex", flexDirection: "column"}} size={{md: 6}}>
                    ...
                    <Stack spacing={2} style={{...shadedBoxStyle, flex: 1}}>
                ...
                <Grid size={{md: 6}} style={{display: "flex", flexDirection: "column"}}>
                    ...
                    <div style={{...shadedBoxStyle, flex: 1}}>
