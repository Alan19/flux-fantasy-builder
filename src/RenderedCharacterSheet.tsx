        ...
        <div>
            <div>
                <div className={"grid middle-align"}>
                    ...
                    <div className={"s8 bottom-margin"}>
                ...
                <div className={"grid top-margin medium-space"}>
                    ...
                    <div className={"l3 s12"}>
                        <Stack spacing={2}>
                            ...
                            <BeerCSSTextField addMargin label={'Other Learned Skills and Techniques'} multiline value={characterSheetFields.otherSkills} onChange={event => characterSheetFields.setOtherSkills(event.target.value)}/>
